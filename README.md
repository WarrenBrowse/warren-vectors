...
| `announcements_v1.json` | signed launch-announcement envelope v1 (`GET /v1/announcements`): the frozen canonical preimage, its signature, and the published document |
